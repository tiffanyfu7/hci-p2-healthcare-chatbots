...
#Config
st.set_page_config(layout="wide", page_icon="💬", page_title="CHAD Chat-Bot 🤖")
...
st.markdown(
    """
    <h1 style='text-align: center;'>CHAD🤖</h1>
    <h2 style='text-align: center;'> Here to Answer Any Inquires About Patient Records </h2>
    """,
...
st.markdown(
    """ 
    <h5 style='text-align:center;'>I'm CHAD, an intelligent chatbot created by combining 
